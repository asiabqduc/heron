...
/**
 * Repository interface for the {@link JobSchedule} entity. It contains methods for
...
@Repository
@Transactional
public interface JobScheduleRepository extends CodeRepository<JobSchedule, Long> {
	/**
	...
	/**
	 * Retrieves a {@link JobSchedule} entity from the underlying datastore by its
	 * Email
	 * 
	 * @param name
	 *            the User's email
	 * @return a User entity
	 * @see JobSchedule#getEmail()
	 */
	JobSchedule findByName(String name);
